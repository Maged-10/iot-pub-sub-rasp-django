...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		...
		def on_message(client, userdata, message):
			...
			table.temperature = msg['field2']
			table.humidity = msg['field1']
			table.accelX = msg['field3']
			table.accelY = msg['field4']
			table.accelZ = msg['field5']
			table.latitude1 = msg['field6']
			table.longitude1 = msg['field7']
			table.save()
